...
function makeRtl() {
    ...
    //     queue.push(...list);
    // });
    // const PAGE_OBSERVER = new MutationObserver(autoAlignPageContent);
    ...
    //     ).forEach((block) => block.setAttribute('dir', 'auto'));
    //
    //     document.querySelectorAll("div[placeholder='List'], div[placeholder='To-do']")
    //         .forEach((item) => item.style['text-align'] = '-webkit-auto');
    // }
}